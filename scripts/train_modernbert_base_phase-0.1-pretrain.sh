...
echo "Starting composer on main.py with configuration: yamls/main/base/flex-bert-rope-phase-0.1-pretrain.yaml"
python -m composer main.py yamls/main/base/flex-bert-rope-phase-0.1-pretrain.yaml