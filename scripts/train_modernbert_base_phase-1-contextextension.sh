...
echo "Starting composer on main.py with configuration: yamls/main/base/flex-bert-rope-phase-1-contextextension.yaml"
python -m composer main.py yamls/main/base/flex-bert-rope-phase-1-contextextension.yaml