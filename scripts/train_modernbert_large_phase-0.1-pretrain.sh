...
echo "Starting composer on main.py with configuration: yamls/main/large/flex-bert-rope-phase-0.1-pretrain.yaml"
python -m composer main.py yamls/main/large/flex-bert-rope-phase-0.1-pretrain.yaml